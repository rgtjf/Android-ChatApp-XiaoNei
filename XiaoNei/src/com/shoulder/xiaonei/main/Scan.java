...
public class Scan extends Activity implements Callback{
	...
	private void initTitle(){
        ...
        left_btn.setOnClickListener(new ButtonLeft());
        text.setText("二维码扫描");
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.substring(0,12).equals("FzjSheYouDzf")){
			int org_id = Integer.parseInt(resultString.substring(13));
			Intent intent = new Intent();
			intent.setClass(Scan.this, SheTuan_Detail.class);
			intent.putExtra("org_id", org_id);
			startActivity(intent);
		}
		else if (resultString.substring(0,4).equals("http")){
    ...
    class ButtonLeft implements OnClickListener{
